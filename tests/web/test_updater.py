...
class TestElementSchemasController(unittest.TestCase):
    def test_read_html_files(self):
        ...
        # Act
        result = controller.read_html_files(directory)

        print(list(result.keys()))
        assert result.get('alchemist').get("fields") == ['bool_anger','bool_anxiety','bool_disheartenment','bool_fear','bool_frustration','bool_sadness','date_input','string_vent']
